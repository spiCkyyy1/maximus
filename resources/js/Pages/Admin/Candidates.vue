<template>
   <admin-layout>
      <div class="main-body">
               ...
               <div class="col-12">
                  <div class="page-heading">
                     <div class="row align-items-center">
                        <div class="col">
                           <div class="meta">
                              <h1 class="title" v-if="all">
                                 <div class="icon"><i class="icon-user"></i></div>
                                 All Candidates
                              </h1>
                              <h1 class="title" v-if="selected">
                                 <div class="icon"><i class="icon-user"></i></div>
                                 Selected Candidates
                              </h1>
                              <h1 class="title" v-if="rejected">
                                 <div class="icon"><i class="icon-user"></i></div>
                                 Rejected Candidates
                              </h1>
                              <h1 class="title" v-if="reviewed">
                                 <div class="icon"><i class="icon-user"></i></div>
                                 Reviewed Candidates
                              </h1>
                              <h1 class="title-xl" v-if="all">All Candidates</h1>
                              <h1 class="title-xl" v-if="selected">Selected Candidates</h1>
                              <h1 class="title-xl" v-if="rejected">Rejected Candidates</h1>
                              <h1 class="title-xl" v-if="reviewed">Reviewed Candidates</h1>
                           </div>
                        </div>
                     </div>
                  </div>
                           ...
                           <table class="table table-hover">
                              ...
                              <tbody>
                                 <tr v-for="(jobSeeker, k) in jobSeekers.data" :key="k">
                                    ...
                                    <td>
                                       <span v-if="jobSeeker.reviewed == 'Unreviewed'">
                                          <inertiaLink :href="route('reviewJobSeeker', {id: jobSeeker.id, review: 1})"><i class="fas fa-eye" title="Reviewed"></i></inertiaLink>
                                       </span>
                                       <span v-if="jobSeeker.reviewed == 'Reviewed'">
                                          <inertiaLink :href="route('reviewJobSeeker', {id: jobSeeker.id, review: 0})"><i class="fas fa-eye-slash" title="Unreviewed"></i></inertiaLink>
                                       </span>
                                    </td>
                                 </tr>
                              </tbody>
         ...
         <div class="h-100" v-if="dataLoaded && jobSeekers.data.length == 0">
            <not-found></not-found>
        </div>
      </div>
