																			...
																			<td>
																				<div class="contentEditableContainer contentTextEditable">
																					<div class="contentEditable" style="text-align: left; color: white;">
																						<h1 style="color: white;">Thank you for registering your interest.</h1>
																						<br>
																						<p style="color: white;">You have successfully completed the registration; you are not eligible for the OJT program.</p>
                                                                                        <p style="color: white;">A member of the team will contact you with regards to other programs available.</p>
																					</div>
																				</div>
																			</td>
																		</tr>
